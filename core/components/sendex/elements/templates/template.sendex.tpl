...
<table>
    <tr>
        <th colspan="2">sxNewsletter Object</th>
    </tr>
    <tr>
        <td>&#91;&#91;+newsletter.id&#93;&#93;</td>
        <td>[[+newsletter.id]]</td>
    ...
    <tr>
        <td>&#91;&#91;+newsletter.email_from&#93;&#93;</td>
        <td>[[+newsletter.email_from]]</td>
    </tr>
    <tr>
        <td>&#91;&#91;+newsletter.email_from_name&#93;&#93;</td>
        <td>[[+newsletter.email_from_name]]</td>
    </tr>
    <tr>
        <td>&#91;&#91;+newsletter.email_reply&#93;&#93;</td>
        <td>[[+newsletter.email_reply]]</td>
    </tr>

    <tr>
        <th colspan="2">sxSubscriber Object</th>
    </tr>
    <tr>
        <td>&#91;&#91;+subscriber.id&#93;&#93;</td>
        <td>[[+subscriber.id]]</td>
    ...
    <tr>
        <td>&#91;&#91;+subscriber.newsletter_id&#93;&#93;</td>
        <td>[[+subscriber.newsletter_id]]</td>
    </tr>
    <tr>
    ...
    <tr>
        <th colspan="2">modUser Object (If a subscriber is an authorized user)</th>
    </tr>
    <tr>
        <td>&#91;&#91;+user.id&#93;&#93;</td>
        <td>[[+user.id]]</td>
    ...
    <tr>
        <th colspan="2">modUserProfile Object (If a subscriber is an authorized user)</th>
    </tr>
    <tr>
        <td>&#91;&#91;+profile.id&#93;&#93;</td>
        <td>[[+profile.id]]</td>
...
<br/><br/>
For example:<br/>
<a href="[[~[[++site_start]]?scheme=`full`&sx_action=`unsubscribe`&code=`[[+subscriber.code]]`]]">Unsubscribe from this
    newsletter</a>
