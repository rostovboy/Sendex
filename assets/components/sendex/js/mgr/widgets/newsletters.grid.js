Sendex.grid.Newsletters = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        , columns: [
            ...
            , {
                header: _('sendex_newsletter_email_from_name'),
                sortable: true,
                dataIndex: 'email_from_name',
                width: 100,
                hidden: true
            }
            , {
                header: _('sendex_newsletter_email_reply'),
                sortable: true,
                dataIndex: 'email_reply',
                width: 100,
                hidden: true
            }
            , {
...
Sendex.window.CreateNewsletter = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        , fields: [
                    ...
                    , items: [
                        {
                            ...
                            name: 'email_subject',
                            id: 'sendex-' + this.ident + '-email_subject',
                            anchor: '100%'
                        }
                        , {
                            xtype: 'textfield',
                            ...
                            name: 'email_reply',
                            id: 'sendex-' + this.ident + '-email_reply',
                            anchor: '100%'
                        }
                        , {
                            xtype: 'combo-boolean',
                    ...
                    , items: [
                        {
                            ...
                            name: 'email_from',
                            id: 'sendex-' + this.ident + '-email_from',
                            anchor: '100%'
                        }
                        , {
                            xtype: 'textfield',
                            ...
                            id: 'sendex-' + this.ident + '-email_from_name',
                            anchor: '100%'
                        }
                        , {
            ...
            , {
                xtype: 'textarea',
                fieldLabel: _('sendex_newsletter_description'),
                name: 'description',
                id: 'sendex-' + this.ident + '-description',
                height: 75,
                anchor: '100%'
            }
        ]
